...
public class subactivity_contact extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("asdf", id);
        new JSONTask().execute("http://143.248.38.245:7080/api/books/email/"+email+"/id/"+id);
...
*/
    ...
    public class JSONTask extends AsyncTask<String, String, String> {
            ...
            try {
                ...
                try{
                    ...
                    try {
                        ...
                        Log.i("error ", "Error getting file name from json");
                        e.printStackTrace();
                    }
                }//finally 부분
            } catch (Exception e) {
        ...
        protected void onPostExecute(String result) {
            Log.i("geteeresult", result);
            new DownloadImageTask(coImage).execute("http://143.248.36.28:5000/files/" + result.substring(1,result.length()-1));

//            super.onPostExecute(result);
//            try {
//
//                new DownloadImageTask(coImage).execute("http://143.248.36.28:5000/files/" + result);
